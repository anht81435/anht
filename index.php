...
<?php
$Header = new Header();
$LoveDays = new LoveDays();
$MusicList = new MusicList();
$Header->CommonMethod();
$LoveDays->CommonMethod();
$MusicList->CommonMethod();
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="author" content="Life Z">
    <meta name="keywords"
        content="<?= $Header->keywords ?>">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <link rel="shortcut icon" href="<?= $Header->favicon ?>?v=<?= rand(
	1,
	999
) ?>" type="image/x-icon">
    ...
    <link rel="stylesheet" href="./res/v5/css/index.css?v=<?php echo rand(
    	1,
    	999
    ); ?>">
...
<body class="BodyStyle">
    ...
    <div id="loading-box">
        <div class="loading-bg">
            <img class="loading-img entered loading" src="<?= $Header->favicon ?>?v=<?= rand(
	1,
	999
) ?>" data-ws-status="loading">
    ...
    <main id="td-main">
            ...
            <div class="td-popup" id="share_card">
                <div class="left">
                    ...
                    <span class="td_copy" title="Nhấn để sao chép">
                        <i class="ri-file-copy-line"></i>&nbsp;https://<?php echo $_SERVER[
                        	"HTTP_HOST"
                        ]; ?>?t=share
                    </span>
                    <div class="button mt-2">
                        ...
                        <span class="td-btn"
                            onclick="window.open('https://www.messenger.com/t/' + encodeURIComponent(''),'top');"
                ...
                <div class="right">
                    ...
                    <img class="avatar-nav"
                        src="https://chart.googleapis.com/chart?chs=96x96&cht=qr&chl=https%3A%2F%2F<?= $_SERVER[
                        	"HTTP_HOST"
                        ] ?>&choe=UTF-8"
                        alt="Qr-code">
                </div>
        ...
        <header id="header">
            <h2>
                <a href="#" class="site-icon"><?= $Header->namesite ?></a>
            </h2>
        ...
        <section class="td-content">
            <div class="about-me">
                <div class="info-left">
                    <span class="tag"><?= $Header->bio1 ?></span>
                    <span class="tag"><?= $Header->bio2 ?></span>
                    <span class="tag"><?= $Header->bio3 ?></span>
                </div>
                <div class="avatar">
                    <img class="avatar-img" src="<?= $Header->avatar ?>?v=<?= rand(
	1,
	999
) ?>" alt="Life Z">
                ...
                <div class="info-right">
                    <span class="tag"><?= $Header->bio4 ?></span>
                    <span class="tag"><?= $Header->bio5 ?></span>
                    <span class="tag"><?= $Header->bio6 ?></span>
                </div>
            </div>
            <div class="padding" style="height:2em;"></div>
            <h2 class="HoVaTen__">
                <span id="userName" data-userName='<?= json_encode(
                	$Header->userName ?? []
                ) ?>'></span>
            </h2>
            <div class="about-me-2">
                <button class="trigger"><?= $Header->trigger ?></button>
                <button class="trigger"><?= $Header->bio1 ?></button>
                <button class="trigger"><?= $Header->bio2 ?></button>
                <button class="trigger"><?= $Header->bio3 ?></button>
                <button class="trigger"><?= $Header->bio4 ?></button>
                <button class="trigger"><?= $Header->bio5 ?></button>
                <button class="trigger"><?= $Header->bio6 ?></button>
            </div>
            <div class="padding" style="height:1em;"></div>
            <section id="hr-mod">
                <?php foreach ($Header->SocialNetworks as $network => $url): ?>
    ...
    <div class="padding" style="height:4em;"></div>
        <div class="love-time1 mt-5">
            <div class="hide" data-ngayyeu="<?= $LoveDays->ConfigLove[
            	"time_relashiption"
            ] ?>"></div>
        ...
        <div class="bg-wrap central mt-5">
            <div class="bg-img">
                <div class="middle animated">
                    <div class="img-male">
                        <img src="<?= $LoveDays->ConfigLove["avatar_male"] ?>"
                            alt="<?= $LoveDays->ConfigLove["name_male"] ?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?= $LoveDays->ConfigLove["name_male"] ?></span>
                    </div>
                    <div class="heart"></div>
                    <div class="img-female">
                        <img src="<?= $LoveDays->ConfigLove["avatar_female"] ?>"
                            alt="<?= $LoveDays->ConfigLove["name_female"] ?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?= $LoveDays->ConfigLove["name_female"] ?></span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        ...
                                        <li url="<?= $song["url"] ?>">
                                            <span class="name">
                                                <img class="singer-avatar ls-is-cached" src="<?= $song[
                                                	"avatar"
                                                ] ?>">
                                                <span class="title">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;"><?= $song[
                                                        	"title"
                                                        ] ?>
                                                        </font>
                                                    </font>
    ...
    <footer id="footer">
        <span>
            <a href="//thanhdieu.com" target="_blank">&copy; Copyright&nbsp;Life Z 2024</a>
        </span>
    </footer>
